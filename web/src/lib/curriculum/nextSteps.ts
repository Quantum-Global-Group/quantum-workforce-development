...
export const OPPORTUNITIES: Opportunity[] = [
  {
    ...
    kind: "summer-school",
    when: "Annual (watch the Qiskit blog for the next cohort)",
  ...
  },
  {
    ...
    who: "Students, educators, community leads. QGG workshop notebooks live in QuantumKev/qiskitFallFest.",
    pathways: "all",
  },
  {
    id: "qiskit-hackathons",
    name: "Qiskit hackathons and challenges",
    kind: "hackathon",
    when: "Rolling — developer conferences and regional challenges",
  ...
  {
    id: "c1000-179",
    name: "Qiskit v2.X Associate Developer certification (C1000-179)",
    kind: "credential",
  ...
  {
    id: "classroom",
    name: "Classroom hardware access",
    kind: "classroom",
    when: "Educator application; 365-day instance, 10 min QPU / 28 days per student",
    where: "Quantum platform — no student credit card",
  ...
  },
  {
    ...
    name: "Business Foundations badge",
    kind: "credential",
    when: "Self-paced (~2–3 hours) + optional exam",
    where: "Partner learning",
  ...
  {
    id: "enigmas",
    name: "Quantum Enigmas (puzzles + optional Qiskit labs)",
    kind: "classroom",
...
export const LINKEDIN_MOVES = [
  {
    ...
    body: "Example: ‘Portfolio analyst exploring quantum optimization | Business Foundations | Qiskit’ or ‘Software engineer | Qiskit v2 | seeking quantum SDK roles’.",
  },
  {
  ...
  },
  {
    ...
    body: "Qiskit, Chattanooga Quantum Collaborative, Q-CTRL, IQM — then comment with substance, not emoji-only.",
  },
  {
...
export const REGION_HUBS: RegionHub[] = [
  {
    ...
    assets: [
      ...
      "Florida Memorial University HBCU Quantum Center",
  ...
  },
  {
    ...
    assets: [
      "Workforce programs, summer intensives, executive education",
  ...
  {
    id: "virtual-ibm",
    name: "Virtual hardware access",
    region: "Anywhere with Classroom or Open Plan access",
